...
class SettingsPage {
     ...
     * @var array
     */
    public static $SETTINGS_SECTIONS = [];
     ...
     * @param array $section
     */
    public function render_sections(array $section): void {
        foreach (static::$SETTINGS_SECTIONS as $sub_section) {
     ...
     */
    public static function save_fields(array $fields): void {
     ...
     */
    public static function sanitize_field($value, string $type) {
        switch ($type) {
            case 'text':
     ...
     */
    public function render_fields(array $field): void {
